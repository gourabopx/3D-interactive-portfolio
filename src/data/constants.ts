...
using use = useUsing("use")`,
  ...
  [SkillNames.VUE]: {
    ...
    color: "#646cff",
    icon: "https://unpkg.com/simple-icons@v11/icons/vite.svg",
  },
  [SkillNames.NEXTJS]: {
    id: 7,
    name: "nextjs",
  ...
  [SkillNames.PRETTIER]: {
    ...
    color: "#4479a1",
    icon: "https://unpkg.com/simple-icons@v11/icons/mysql.svg",
  },
  [SkillNames.NPM]: {
    id: 16,
    name: "npm",
  ...
  [SkillNames.LINUX]: {
    ...
    color: "#46e3b7",
    icon: "https://unpkg.com/simple-icons@v11/icons/render.svg",
  },
  [SkillNames.DOCKER]: {
    id: 20,
    name: "docker",
  ...
  [SkillNames.VIM]: {
    ...
    color: "#777bb4",
    icon: "https://unpkg.com/simple-icons@v11/icons/php.svg",
  },
  [SkillNames.VERCEL]: {
    id: 24,
    name: "vercel",
